...
class Robot3(Node):
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(RobotPosition, 'robot_3/position', 10)
        self.subscription_1 = self.create_subscription(RobotPosition, 'robot_1/position', self.listener_callback, 10)
